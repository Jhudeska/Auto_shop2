            ...
            <div class="row">
                <div class="calculator-block">
                    ...
                    <form action="#" method="get" class="row calculator-form">
                        ...
                        <div class="form-row col-12 pl-5 col-md-10">
...
<!--                            </div>-->
                            ...
                            <div class="form-row justify-content-center col-12">
                                ...
                                <div class="form-row col-12 ">
                                    <input class="btn btn-left " type="submit" name="submit" value="Versturen"  onclick="" onClick="javascript:showMonthlyPayment();">
                                </div>
                    </form>
